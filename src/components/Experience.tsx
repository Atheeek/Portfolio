...
import cdacLogoUrl from '../assets/Preview-22.png';
...
const experiences = [
  {
    ...
    description: [
      'Completed Govt. of India–certified full stack training in React.js, Node.js, MongoDB, SQL, and Tailwind CSS.',
      'Built a Municipality Complaint Management System with real-time tracking and user verification.',
      'Developed responsive UIs, REST APIs, and implemented agile methodologies.'
    ],
    technologies: ['React.js', 'Node.js', 'MongoDB', 'SQL', 'Tailwind CSS'],
  },
 {
  id: 2,
  title: 'DevOps Intern',
  ...
  description: [
    'Built a CI/CD pipeline using Jenkins for automated testing and deployment.',
    'Integrated Git, Maven, and Jenkins to streamline the build and delivery process.',
    'Configured and managed Docker containers to support isolated testing environments.',
  ],
  technologies: ['Jenkins', 'Git', 'Maven', 'Docker', 'Linux'],
}
